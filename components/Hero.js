...
>
            ...
            <div className="mt-6 text-sm text-slate-500">Trusted by startups and SMBs — design, build, and scale.</div>
          </motion.div>

          <motion.div className="flex justify-center md:justify-end" initial={ x:30, opacity:0 } animate={ x:0, opacity:1 } transition={ duration:0.6 }>
            <div className="w-full max-w-md relative">
              <Image src="/assets/laptopmockups.png" alt="hero mockup" width=720 height=480 style={objectFit:'contain'}/>
            </div>
          </motion.div>
        </div>
      </div>
